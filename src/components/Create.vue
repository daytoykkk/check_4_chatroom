<template>
    <div class="createGroup">
        ...
        <div class="settingAccount">
            ...
            <input type="text" id="cgName" class="form-control" placeholder="Group Name">
        </div><br>
        <div class="settingAccount">
            <label for="cgTopic">Topic(optional)</label>
            <input type="text" id="cgTopic" class="form-control" placeholder="Group Topic">
        </div><br>
        <div class="settingAccount">
            <label for="cgDes">Description</label>
            <input type="text" id="cgDes" class="form-control" placeholder="Group Description">
        </div><br><br>
        <center><button type="button" class="btn btn-primary btn-lg ">Create group</button></center>
